...
if(! defined('JPEG_IS_PROGRESSIVE') )		define ('JPEG_IS_PROGRESSIVE', TRUE);					// Define if a created jpeg image is progressive
...
class timthumb {
	...
	public function __construct(){
		...
		$this->myHost = preg_replace('/^www\./i', '', 'localhost');
		// 		s3-eu-west-1.amazonaws.com
		//        d140srgaa8im7v.cloudfront.net
		//        nalbes.a4aim.com
		//        localhost/nalbes

		$this->src = 'https://'.urldecode($this->param('src'));
