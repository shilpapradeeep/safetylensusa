            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">PD Right Value</h5>
                    ...
                    <div class="modal-body">
                        <div class="col-xl-12 col-md-12 input-divs">
                         <?php if(!empty($pd_right_value))  
                         {     $num = 0;
                            foreach ($pd_right_value as $value) { 
                              $num++;
                             ?>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-sm-2">
                                            <a class="btn btn-danger text-white remove-new-value" typ='pd_right_value' fet='<?=$num?>' title="Edit"><i class="fa fa-times"></i></a>
                                        </div>
                                    <?php }else{?>

                                        <div class="col-md-2 col-sm-2">
                                            <a class="btn btn-primary text-white add-new-value" typ="pd_right_value" title="Edit"><i class="fa fa-plus"></i></a>
                                        </div>
                                    <?php } ?>
...
<?php  } ?>
                    ...
                    <input type="hidden" name="type" value="pd_right_value">
