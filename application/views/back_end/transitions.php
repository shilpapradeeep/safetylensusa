            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <a style="margin-bottom: 10px;" class="btn btn-primary text-white" id="transitions_add">Add new</a>
                        <!-- end page title -->
                        <div id="list-viewed">
        ...
        <div class="modal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <?=form_open('',array('id'=>'transitions_form','autocomplete'=>'off'))?>
                    <input type="hidden" name="tr_id" id="tr_id" value="">
                    <div class="modal-body">
                        <div class="col-xl-12 col-md-12">
                            <div class="form-group">
                                <label for="tr_name">Name/Title <span class="star">*</span></label>
                                <input type="text" class="form-control" id="tr_name" name="tr_name" placeholder="Enter the Name/Title" autofocus="autofocus" onfocus="this.select()">
