		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<div mc:edit="text_3">
						The transaction failed and the payment has not been validated.
						
						<span>Please try again later.</span>
						<!-- You can now start the payment again by refreshing the order page, You may attempt the payment once again, though it is recommended you use another payment method.
						<br> -->
						<br>
					</div>
				</td>
				...
				<tr>
					<td>
						<p style="padding-bottom:5px;color:#e05416;font-size: 12px;text-align: center;padding-bottom: 5px">If any money debited, will be reimbursed within 48 hours.</p>
					</td>
				</tr>
				<!-- Button -->
				<tr mc:hideable>
