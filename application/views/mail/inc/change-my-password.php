		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<div mc:edit="text_3">
						Your password changed successfully.If it is not done by you please <a target="_blank"  style="color:#f50a29; text-decoration:none;" href="<?=b('contact-us');?>">contact us</a> 
					</div>
				</td>
				</tr>
				<!-- Button -->
